        ...
        else
        {
            if(coinNumbers>0)
            {
                ...
                else
                {
                    ...
                    const userData = JSON.stringify({'id':loginCredentials.data._id,'amount':newAmount,'coin':coin,'quantity':coinNumbers, 'FollowersId':loginCredentials.data.followersId})
